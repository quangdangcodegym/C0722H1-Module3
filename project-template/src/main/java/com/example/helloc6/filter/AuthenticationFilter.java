...
import com.example.helloc6.security.SecurityUtils;
import com.example.helloc6.security.UserRoleRequestWrapper;
...
public class AuthenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if(checkResource){
            ...
            boolean checkUserNamePasswordCookie = iUserDAO.checkUserExists(username, password);
            ...
            if(checkUserNamePasswordCookie==true){
                UserRoleRequestWrapper req_UserRoleRequestWrapper =
                        new UserRoleRequestWrapper(username, iUserDAO.getUserRoles(username), req);
