                                ...
                                <div class="col-8">
                                    ...
                                    <form method="post">
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-10">
                                                <input class="form-control" type="text" name="name" value="${requestScope.user.getName()}">
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            <div class="col-2">
                                            ...
                                            <div class="col-10">
                                                <input class="form-control" type="text" name="email" value="${requestScope.user.getEmail()}">
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            <div class="col-2">
